...
ProjectDir="C:\Users\tkliman\Desktop\git_connected_finalproject\cmpe118_finalproject_software-devel.X"
ConfName=default
...
${OBJECTDIR}/SubHsmTrackWireAlign.c.o: SubHsmTrackWireAlign.c.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/SubHsmTrackWireAlign.c.o.d 
	@${RM} ${OBJECTDIR}/SubHsmTrackWireAlign.c.o 
	@${FIXDEPS} "${OBJECTDIR}/SubHsmTrackWireAlign.c.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -I"C:/CMPE118/include" -I"." -MMD -MF "${OBJECTDIR}/SubHsmTrackWireAlign.c.o.d" -o ${OBJECTDIR}/SubHsmTrackWireAlign.c.o SubHsmTrackWireAlign.c.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
