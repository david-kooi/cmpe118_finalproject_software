...
#define InitDrive() (COIL_A_DIRECTION = 1, COIL_B_DIRECTION = 1)
#endif
#ifdef HALF_STEP_DRIVE
#define ShutDownDrive() (COIL_A_ENABLE = 0, COIL_B_ENABLE = 0)
#define TurnOnDrive() (COIL_B_ENABLE = 1, COIL_A_ENABLE = 0)
#define InitDrive() (COIL_B_ENABLE = 1, COIL_B_DIRECTION = 1, COIL_A_ENABLE = 0)
#endif
#ifdef WAVE_DRIVE
#define ShutDownDrive() (COIL_A_ENABLE = 0, COIL_B_ENABLE = 0)
#define TurnOnDrive() (COIL_B_ENABLE = 1, COIL_A_ENABLE = 0)
...
#endif
#ifdef DRV8811_DRIVE
#define ShutDownDrive() do{\
    DRV8811_ENABLE = 0;} while(0)
#define TurnOnDrive() do{\
...
#define TurnOn8811() do{\
    ...
    DRV8811_ENABLE = 1;\
    uint32_t i;\
    for (i = 0; i < ENABLE_WAIT; i++);} while(0)
#endif
...
static enum {
    ...
    step_five, step_six, step_seven, step_eight
} coilState = step_one;
